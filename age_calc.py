...
def main_screen():
  ...
  Label(text = "", bg = "grey", width = "300", height = "2", font = ("pink", 13)).pack()
  Label(text = "").pack()
  Label(text = "NAME", height = "2", width = "30", command = login).pack()
  Label(text = "").pack()
  Label(text = "YEAR",height = "2", width = "30", command = register).pack()
'''
...
def calculateAge() : 
	...
	if value == -1 : 
		...
		rsltDayField.insert(1, str(calculated_day)) 
		rsltMonthField.insert(1, str(calculated_month)) 
		rsltYearField.insert(1, str(calculated_year)) 
...
if __name__ == "__main__" : 
	...
	resultantAge = Button(gui, text = "Resultant Age", fg = "Black", bg = "pink", command = calculateAge) 

	# Create a Clear All Button and attached to clearAll function 
	clearAllEntry = Button(gui, text = "Clear All", fg = "Black", bg = "pink", command = clearAll) 
